    ...
    <div className="min-h-dvh flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-accent-500 to-accent-700 p-12 flex-col justify-between text-white">
        <div>
          ...
          <p className="text-accent-200 mt-1">Pilotage de parcours</p>
        </div>
        <div className="space-y-5">
          <h2 className="text-xl font-semibold">Créez votre compte gratuitement</h2>
          {['Suivi visuel de vos candidatures', 'Gestion des bourses et aides', 'Objectifs et jalons personnalisés', 'Tous vos documents au même endroit'].map((t, i) => (
