...
export function Header() {
  ...
  return (
    <header className="md:hidden sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-surface-200/80 px-4 py-2.5">
      <div className="flex items-center justify-between">
        <h1 className="text-base font-bold font-heading text-primary-700">MyCheckList</h1>
          ...
          <div className="relative">
            ...
            {menuOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1 w-56 bg-white rounded-xl shadow-lg border border-surface-200 py-2 z-20">
